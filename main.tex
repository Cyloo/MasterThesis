...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %\depart{数理化和信息工程系}
  \major{计算机应用技术专业}%专业，硕博请用全称，本科不需要
  \advisor{唐珂\ 教授}
...
\mainmatter
  ...
  \include{chapter/chap-4-implements} %第四章，实现细节   15000
  \include{chapter/chap-5-experiments} %第五章，实验   3000
  \include{chapter/chap-6-future-work} %第六章，后续工作  2000
  \include{chapter/chap-7-conclusion} %第七章，结论 1000
